...
<head>
    ...
    <link href="<?= aa_asset_url('assets/admin/'); ?>/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    ...
    <script src="<?= aa_asset_url('assets/dashboard'); ?>/vendor/jquery/jquery.min.js"></script>
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('admin/dashboard'); ?>">
            <div class="sidebar-brand-icon">
                <img src="<?= aa_asset_url('assets/base'); ?>/img/logo-baru.png" style="
    filter: brightness(5);
" height="50">
            </div>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="img-profile rounded-circle" src="<?= aa_asset_url('assets/dashboard'); ?>/img/boy.png" style="max-width: 60px">
                            <span class="ml-2 d-none d-lg-inline text-black small" style="color:black"><?= $_SESSION['uname_admin'] ?></span>
                        </a>
...
<a class="scroll-to-top rounded" href="#page-top">
    ...
    <div class="modal" id="myModal">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 1030px;margin: 0.75rem auto;min-height: calc(100% - 3.5rem);">
...
<script src="<?= aa_asset_url('assets/dashboard'); ?>/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="<?= aa_asset_url('assets/dashboard'); ?>/vendor/jquery-easing/jquery.easing.min.js"></script>
<script src="<?= aa_asset_url('assets/dashboard'); ?>/vendor/datatables/jquery.dataTables.min.js"></script>
<script src="<?= aa_asset_url('assets/dashboard'); ?>/vendor/datatables/dataTables.bootstrap4.min.js"></script>
<script src="<?= aa_asset_url('assets/dashboard'); ?>/js/ruang-admin.js"></script>

<!-- cart -->
<script src="<?= aa_asset_url('assets/dashboard'); ?>/vendor/chart.js/Chart.min.js"></script>
<script src="<?= aa_asset_url('assets/dashboard'); ?>/js/demo/chart-area-demo.js"></script>
